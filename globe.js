...
// WebGL may be unavailable (e.g. iOS Lockdown Mode, locked-down work devices).
// Detect it and show a graceful static fallback instead of a blank area.
...
if (!isWebGLAvailable()) {
  if (container) {
    container.innerHTML = '<div class="webgl-fallback"><div class="wf-orb" aria-hidden="true"></div></div>';
  }
} else {
  initGlobe();
}
